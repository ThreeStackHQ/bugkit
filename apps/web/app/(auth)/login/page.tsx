    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white">BugKit</h1>
          <p className="text-zinc-400 mt-2 text-sm">
            Bug reporting for indie SaaS. Sentry, but $9/mo.
          </p>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-xl">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <Button
                type="submit"
                className="w-full bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 flex items-center justify-center gap-3"
                variant="outline"
              >
